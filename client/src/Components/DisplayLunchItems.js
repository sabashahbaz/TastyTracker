...
function DisplayLunchItems({item, deleteItem}) {
    ...
    return (
        <div className="lunch-item list-group-item list-group-item-action list-group-item-primary justify-content-center w-100">
            ...
            {/* <div div class="position-absolute bottom-50 end-0" onClick={() => deleteItem(item)}>
                <svg onClick={() => deleteItem(item)} xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
